...
% COM trajectory
COMtot = wpg_upd(delta_t,[0;0;0;0;0;0;COMz_wpg;0;0],Feet(size(Feet,1),5)+Feet(1,5),ZMP_traj(:,1),...
    ZMP_traj(:,2),0.6*C_rob(3),0.8*C_rob(3));
COMx = COMtot(1,:); COMy = COMtot(4,:); COMz = COMtot(7,:);
