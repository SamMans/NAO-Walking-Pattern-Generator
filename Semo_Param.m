...
% Robot dimensions
    ...
    z_spacing = 0; % Spacing between pelvis center and legs in z-axis
    y_spacing = 0.05; % Spacing between pelvis center and legs in y-axis
    lth = 0.1; % Thigh length
    ltb = 0.1; % Tibia length
    lft = 0.045; % Foot height
...
% First link "Body"
    ...
    L(1).m = 2.8; % Link mass
    L(1).COM = [0;0;0.15]; % Link COM relative to local link coord.
    L(1).I = [0.001 0 0;
              0 0.001 0;
              0 0 0.001]; % Link moment of inertia (local frame)
...
% Second link "RLEG_J0"
    ...
    L(2).m = 0.07; % Link mass
    L(2).COM = [0;0;0]; % Link COM relative to local link coord.
    L(2).I = [0.0001 0 0;
              0 0.0001 0;
              0 0 0.0001]; % Link moment of inertia (local frame)
...
% Third link "RLEG_J1"
    ...
    L(3).m = 0.14; % Link mass
    L(3).COM = [0;0;0]; % Link COM relative to local link coord.
    L(3).I = [0.0001 0 0;
              0 0.0001 0;
              0 0 0.0001]; % Link moment of inertia (local frame)
...
% Fourth link "RLEG_J2"
    ...
    L(4).COM = [lth/2;0;0]; % Link COM relative to local link coord.
    L(4).I = [0.001 0 0;
              0 0.001 0;
              0 0 0.001]; % Link moment of inertia (local frame)
 ...
 % Fifth link "RLEG_J3"
    ...
    L(5).m = 0.3; % Link mass
    L(5).COM = [ltb/2;0;0]; % Link COM relative to local link coord.
    L(5).I = [0.001 0 0;
              0 0.001 0;
              0 0 0.001]; % Link moment of inertia (local frame)
 ...
 % Sixth link "RLEG_J4"
    ...
    L(6).m = 0.13; % Link mass
    L(6).COM = [0;0;0]; % Link COM relative to local link coord.
    L(6).I = [0.0001 0 0;
              0 0.0001 0;
              0 0 0.0001]; % Link moment of inertia (local frame)
 ...
 % Seventh link "RLEG_J5"
    ...
    L(7).m = 0.18; % Link mass
    L(7).COM = [lft/2;0;0]; % Link COM relative to local link coord.
    L(7).I = [0.001 0 0;
              0 0.001 0;
              0 0 0.001]; % Link moment of inertia (local frame)
 ...
 % Ninth link "LLEG_J1"
    ...
    L(9).m = 0.14; % Link mass
    L(9).COM = [0;0;0]; % Link COM relative to local link coord.
    L(9).I = [0.0001 0 0;
              0 0.0001 0;
              0 0 0.0001]; % Link moment of inertia (local frame)
...
% Tenth link "LLEG_J2"
    ...
    L(10).m = 0.38; % Link mass
    L(10).COM = [lth/2;0;0]; % Link COM relative to local link coord.
    L(10).I = [0.001 0 0;
              0 0.001 0;
              0 0 0.001]; % Link moment of inertia (local frame)
 ...
 % Eleventh link "LLEG_J3"
    ...
    L(11).m = 0.3; % Link mass
    L(11).COM = [ltb/2;0;0]; % Link COM relative to local link coord.
    L(11).I = [0.001 0 0;
              0 0.001 0;
              0 0 0.001]; % Link moment of inertia (local frame)
 ...
 % Twelveth link "LLEG_J4"
    ...
    L(12).m = 0.13; % Link mass
    L(12).COM = [0;0;0]; % Link COM relative to local link coord.
    L(12).I = [0.0001 0 0;
              0 0.0001 0;
              0 0 0.0001]; % Link moment of inertia (local frame)
 ...
 % Thirteenth link "LLEG_J5"
    ...
    L(13).m = 0.18; % Link mass
    L(13).COM = [lft/2;0;0]; % Link COM relative to local link coord.
    L(13).I = [0.001 0 0;
              0 0.001 0;
              0 0 0.001]; % Link moment of inertia (local frame)
